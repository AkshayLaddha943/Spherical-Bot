...
This repository encapsulates the information related to board dimensions, electronics, sensors and its testing scripts, to controller node for the development of Spherical Bot 3.0 

## Table of Contents

* [Hardware](https://github.com/AkshayLaddha943/Arrow_SensorFusion_turtlebot3_ws#cloning-the-repository)
  * [Hardware Requirement](#hardware-setup)
  * [PCB Dimensions](#hardware-requirements)
* [Software](https://github.com/AkshayLaddha943/Arrow_SensorFusion_turtlebot3_ws#installing-required-rosdep-packages-and-dependencies)
  * [Software Pre-Requisites](#software-installation)
  * [IMU Test](#software-installation)
  * [Picamera Test](#software-configuration)
  * [Motor Test](#software-installation)
  * [Forward, Left & Right Motion](#software-configuration)
